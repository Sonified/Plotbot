...
class psp_dfb_class:
    ...
    times_mesh_ac_dv12: Optional[np.ndarray]  # Time mesh for AC dv12 spectral plotting
    times_mesh_ac_dv34: Optional[np.ndarray]  # Time mesh for AC dv34 spectral plotting
    times_mesh_dc_dv12: Optional[np.ndarray]  # Time mesh for DC dv12 spectral plotting
    ...
    dc_spec_dv12: plot_manager    # DC spectrum from antenna pair 1-2 (only available)
