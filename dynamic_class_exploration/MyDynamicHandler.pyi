...
def create_data_class(class_name_str: str, metadata: dict) -> type[MyDynamicHandler]: ...

class MyDynamicHandler:
    _metadata: dict
    class_name: str
    data_type: str
    ...
    var1: SimplePlotManager
    var2: SimplePlotManager
    var_sum: SimplePlotManager
