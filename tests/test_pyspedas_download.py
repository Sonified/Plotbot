...
# === Test Added: Basic SPDF Download with Cleanup (Based on stardust version) ===

@pytest.mark.mission("Pyspedas Test: Basic SPDF Download with Cleanup (mag_RTN_4sa)")
def test_pyspedas_download_with_cleanup(): # Renamed function
