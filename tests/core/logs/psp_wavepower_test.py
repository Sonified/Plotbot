...
Generated on: 2025-07-23T12:15:45.713770
...
class psp_wavepower_test_class:
    """
    ...
    def __init__(self, imported_data):
        ...
        object.__setattr__(self, 'class_name', 'psp_wavepower_test')
        object.__setattr__(self, 'data_type', 'psp_wavepower_test')
        ...
        if imported_data is None:
            ...
            print_manager.dependency_management("Calculating psp_wavepower_test variables...")
            self.calculate_variables(imported_data)
            self.set_ploptions()
            print_manager.status("Successfully calculated psp_wavepower_test variables.")
        
        # Auto-register with data_cubby (following plotbot pattern)
        from plotbot.data_cubby import data_cubby
        data_cubby.stash(self, class_name='psp_wavepower_test')
        print_manager.dependency_management("Registered psp_wavepower_test with data_cubby")
    ...
    def __getattr__(self, name):
        ...
        print_manager.dependency_management('psp_wavepower_test getattr helper!')
    ...
    def __setattr__(self, name, value):
        ...
        if name in allowed_attrs or name in self.raw_data:
            ...
            print_manager.dependency_management('psp_wavepower_test setattr helper!')
            print(f"'{name}' is not a recognized attribute, friend!")
            available_attrs = list(self.raw_data.keys()) if self.raw_data else []
            print(f"Try one of these: {', '.join(available_attrs)}")
    ...
    def set_ploptions(self):
        ...
        print_manager.dependency_management("Setting up plot options for psp_wavepower_test variables")
        

        self.wavePower_LH = plot_manager(
            self.raw_data['wavePower_LH'],
            plot_options=ploptions(
                data_type='psp_wavepower_test',
                var_name='wavePower_LH',
                class_name='psp_wavepower_test',
...
psp_wavepower_test = psp_wavepower_test_class(None)
print_manager.dependency_management('initialized psp_wavepower_test class')
